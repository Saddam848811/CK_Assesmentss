...
import AccountManagement from "../../Dashboards/UserAccountManagement/AccountManagement";
    ...
    <div className="w-[100vw] bg-[#f6f2f2]">
      ...
      <div className="shadow-2xl w-[90%] m-9 bg-white rounded p-6">
        <div className="flex items-center my-5">
          <AddUserButton onClick={()=> navigate("/add-user")} text={"+ Add User"} />
          <input
            type="text"
                ...
                >
                  ...
                  <td className="px-1 py-2 flex justify-between items-center">
                    <label className="relative inline-flex items-center cursor-pointer">
                      ...
                      />
                      <div
                        className="w-11 h-6 bg-gray-200 rounded-full peer peer-checked:bg-blue-400
                 ...
                 after:h-5 after:w-5 after:transition-all peer-checked:after:translate-x-full"
                    ...
                    <div className="relative w-fit">
                      <button onClick={()=>{navigate('add-user')}} className="bg-blue-50 text-black rounded-full hover:bg-[#b9dffc] focus:ring-2 focus:ring-blue-100 transition-colors group p-2">
                        🖋
                        <span
                          className="absolute left-1/2 -translate-x-1/2 mt-2 opacity-0 
